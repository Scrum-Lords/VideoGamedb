...
public class VideoGameDAO implements IVideoGameDAO {
    ...
    @Override
    public VideoGame retrieveRecordByName(String name) {
        final String QUERY = "select *"
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            System.out.println("retrieveRecordByName SQLException: "
                    + ex.getMessage());
        }
    ...
    @Override
    public VideoGame retrieveRecordByConsole(String console) {
        final String QUERY = "select *"
                + " from videogame where console = '" + console + "'";
        VideoGame game = null;
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            System.out.println("retrieveRecordByConsole SQLException: "
                    + ex.getMessage());
        }
    ...
    @Override
    public VideoGame retrieveRecordByRating(String rating) {
        final String QUERY = "select *"
                + " from videogame where rating = '" + rating + "'";
        VideoGame game = null;
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            System.out.println("retrieveRecordByRating SQLException: "
                    + ex.getMessage());
        }
    ...
    @Override
    public VideoGame retrieveRecordByDeveloper(String developer) {
        final String QUERY = "select *"
                + " from videogame where developer = '" + developer + "'";
        VideoGame game = null;
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            System.out.println("retrieveRecordByDeveloper SQLException: "
                    + ex.getMessage());
        }
    ...
    @Override
    public List<VideoGame> retrieveAllRecordsDec() {
        final List<VideoGame> myList = new ArrayList<>();
        final String QUERY = "select id, name, developer, console, "
                + "rating from videogame ORDER BY id DESC";
